...
* shared contribution'
---
Jan-Philipp Quast and me developed an R package to simplify our LiP-MS data analyses, as well as make them more reproducible. 
The result was the R package "protti" that can be used for quality control, data analysis and data interpretation of common bottom-up proteomics and LiP-MS analyses.